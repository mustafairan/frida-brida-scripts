...
//frida -D emulator-5554 -l ./androidDefaultHooks.js -f us.hsbc.hsbcus.cert.release --no-pause
...
function androidpinningwithca1() {
	...
	// output parametresi
	var output = true;  // false yaparsan loglar çıkmaz

// Load CAs from an InputStream
		if (output) console.log("[+] Loading our CA...");
	...
	var certInfo = Java.cast(ca, X509Certificate);
		if (output) console.log("[o] Our CA Info: " + certInfo.getSubjectDN());

// Create a KeyStore containing our trusted CAs
		if (output) console.log("[+] Creating a KeyStore for our CA...");
...
// Create a TrustManager that trusts the CAs in our KeyStore
		if (output) console.log("[+] Creating a TrustManager that trusts the CA in our KeyStore...");
	var tmfAlgorithm = TrustManagerFactory.getDefaultAlgorithm();
	var tmf = TrustManagerFactory.getInstance(tmfAlgorithm);
	tmf.init(keyStore);
		if (output) console.log("[+] Our TrustManager is ready...");

		if (output) console.log("[+] Hijacking SSLContext methods now...");
		if (output) console.log("[-] Waiting for the app to invoke SSLContext.init()...");
	...
	SSLContext.init.overload(
	    ...
	    "java.security.SecureRandom"
			...
			if (output) console.log("[o] App invoked javax.net.ssl.SSLContext.init...");
	    SSLContext.init.overload(
 	       "[Ljavax.net.ssl.KeyManager;", 
 	       "[Ljavax.net.ssl.TrustManager;", 
 	       "java.security.SecureRandom"
 	   ).call(this, a, tmf.getTrustManagers(), c);
			if (output) console.log("[+] SSLContext initialized with our custom TrustManager!");
	};
	...
	*/
	...
	function hookCipherInit2() {
	    ...
	    cipherInit.implementation = function (mode, secretKey) {
	        console.log("[Cipher.init()]: mode: " + decodeMode(mode) + ", secretKey: " + secretKey.$className +" :" +base64ArrayBuffer(secretKey.getEncoded()) +" , cipherObj: " + this);
	...
	function hookCipherInit3() {
	    ...
	    cipherInit.implementation = function (mode, secretKey, alParam) {
	        console.log("[Cipher.init()]: mode: " + decodeMode(mode) + ", secretKey: " + secretKey.$className + " :" +base64ArrayBuffer(secretKey.getEncoded())  +" alParam:" + alParam + " , cipherObj: " + this);
	...
	function hookCipherInit4() {
	    ...
	    cipherInit.implementation = function (mode, secretKey, spec) {
	        console.log("[Cipher.init()]: mode: " + decodeMode(mode) + ", secretKey: " + secretKey.$className + " :" +base64ArrayBuffer(secretKey.getEncoded())  +" spec:" + spec + " , cipherObj: " + this);
	...
	function hookCipherInit6() {
	    ...
	    cipherInit.implementation = function (mode, secretKey, secureRandom) {
	        console.log("[Cipher.init()]: mode: " + decodeMode(mode) + ", secretKey: " + secretKey.$className + " :" +base64ArrayBuffer(secretKey.getEncoded())  +" secureRandom:" + secureRandom + " , cipherObj: " + this);
	...
	function hookCipherInit7() {
	    ...
	    cipherInit.implementation = function (mode, secretKey, spec, secureRandom) {
	        console.log("[Cipher.init()]: mode: " + decodeMode(mode) + ", secretKey: " + secretKey.$className + " :" +base64ArrayBuffer(secretKey.getEncoded())  +" spec:" + spec + " secureRandom: " + secureRandom + " , cipherObj: " + this);
	...
	function hookCipherInit8() {
	    ...
	    cipherInit.implementation = function (mode, secretKey, alParam, secureRandom) {
	        console.log("[Cipher.init()]: mode: " + decodeMode(mode) + ", secretKey: " + secretKey.$className +" :" +base64ArrayBuffer(secretKey.getEncoded())  + " alParam:" + alParam + " secureRandom: " + secureRandom + " , cipherObj: " + this);
...
/*	--------------------EKLEME*/
	function hexdumpJS(buffer, offset = 0, length = buffer.byteLength) {
